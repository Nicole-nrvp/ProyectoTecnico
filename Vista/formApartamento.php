...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/formapartamento.css">
...
<header>
		<div class="cuerpo">
		<h2><font face="georgia"><center> Hola, bienvenid@ al modulo de apartamento  </center></font></h2>
		<center><br>
			En este modulo encontras la famosa CRUD, acá podras consultar todos los apartamentos del conjunto o uno en especifico, puedes registrar,  modificar y eliminar.
			<br>
			<br>
	...
	<br>
	<br>
	<a href="formMostrarA.php"><input type="submit"  value="Mostrar Todo"name="Mostrar Todo"></a>	
	<BR>
	<input type="submit" name="" value="Inhabilitar Apartamento">	
	<input type="submit" name="" value="Registrar Apartamento">	
