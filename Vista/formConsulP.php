...
<center><br>
	...
	<br>
		...
		<input type="number" name="" placeholder="Id Parqueadeo"  ><br>
	<br>
	<br>
		<input type="number" name="" placeholder="Id Usuario "><br>
	<br>
	<br>
	    <input type="text" name="" placeholder=" Placa  Vehiculo "><br>
	...
	<a href="formParqueadero.php"><input type="submit"  value="Volver"name="Volver"></a>
