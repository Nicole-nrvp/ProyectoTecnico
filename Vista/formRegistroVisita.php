...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/formregistrovisita.css">
...
<header>
		<div class="cuerpo">
		<h2><font face="georgia"><center> Hola, bienvenid@ al modulo registro de visitas   </center></font></h2>
		<center><br>
			En este modulo encontras la famosa CRUD, acá podras consultar todos los las visitas del conjunto, puedes registrar,  modificar y eliminar.
			<br>
			<br>
	...
	<br>
	<br>
	<a href="formMostrarR.php"><input type="submit"  value="Mostrar Todo"name="Mostrar Todo"></a>	
	<BR>
	<input type="submit" name="" value="Inhabilitar Visita">	
	<input type="submit" name="" value="Registrar Visita">	
</center>
